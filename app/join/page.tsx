...
export default function Page() {
	...
	router.push("/details?type=skilled");
	return (
		<>
			<Head>
			...
			<div className="flex flex-col md:flex-row min-h-screen">
				...
				>
					...
					>
						هل أنت مطور، مصمم، أو تمتلك مهارات مميزة؟ انضم إلينا
						وساهم في تنفيذ مشاريع هادفة تخدم مجتمعنا الإسلامي وتحدث
						تغييراً إيجابياً.
					</p>
					<Button
						text="تعرف أكثر"
				...
				>
					...
					<p
						...
						style={{ color: "#ccc" }} // Subtle secondary text
					>
						ليس لديك مهارات تقنية؟ لا تقلق! يمكنك الانضمام إلينا
						والمساعدة في دعم المشاريع والمجتمع بطرق أخرى مفيدة
						ومؤثرة.
					</p>
					<Button
						text="تعرف أكثر"
